...
| 정적 배열 | `Array(3)` 생성 후 `arr[i]` 읽기/쓰기 | [x] |
...
| 배열 오류 처리 | 범위 초과, 인덱스 타입 오류, 비배열 인덱싱, 크기 타입 오류 | [x] |
...
CodeFab 언어의 1일차 문법과, 3일차 함수(Chapter 2)·클래스(Chapter 3)·정적 배열 문법은 Lexer → Parser → Checker →
